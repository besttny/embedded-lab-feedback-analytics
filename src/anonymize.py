...
def main():
    ...
    # ตัดช่องว่างหัวท้ายทุก field
    for c in ["section", "category"]:
        df[c] = df[c].astype(str).str.strip()

    # คอลัมน์ผลลัพธ์ตามลำดับ
